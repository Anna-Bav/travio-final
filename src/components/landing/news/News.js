         ...
         <div className='news'>
            <div className='news_inner'>
                ...
                <div className='news_blocks'>
                    ...
                    <div className='news_blocks1'>
                    <div className='news_block'>
                        <div className='news_img'><img src='/images/news_1.svg'/></div>
                        <div className='news_date1'>09.02.2022</div>
                        <div className='news_title'>Мальдивы исчезнут, если не остановить изменение климата</div>
                        <div className='news_text'>Мальдивские острова к концу этого столетия исчезнут, если не остановить изменение климата, заявил президент страны Ибрагим Солих, выступая на климатическом саммите.</div>
                        <div className='news_date2'>Читать</div>
                    ...
                    <div className='news_block'>
                        ...
                        <div className='news_date1'>09.02.2022</div>
                        <div className='news_title'>"Морские сопли" покрыли берега Мраморного моря</div>
                    ...
                    <div className='news_block'>
                        ...
                        <div className='news_date1'>09.02.2022</div>
                        <div className='news_title'>Ужас для экологов: как крошится ледник в Гренландии</div>
                        <div className='news_text'>Таяние ледников этого огромного острова влияет на уровень воды в мировом океанеи климат во всем мире.</div>
                        <div className='news_date2'>Читать</div>
